function ShowProduct() {
    ...
    for (let i = 0; i < dataProductObj.length; i++) {
        rowProduct += `<tr class="rem1">
                        ...
                        <td class="invert-image"><a href="single.html"><img src="${dataProductObj[i].imageProduct}" alt=" " class="img-responsive"></a></td>
                        <td class="invert">${dataProductObj[i].quatityProduct}</td>
                        <td class="invert">${dataProductObj[i].nameProduct}</td>
                        <td class="invert">${dataProductObj[i].priceProduct}</td>
                        <td class="invert">
